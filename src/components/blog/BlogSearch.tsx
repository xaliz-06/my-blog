...
const BlogSearch = ({ posts }: SearchProps) => {
  ...
  return (
    <div className="min-h-screen mt-12 mb-20">
      <div className="max-w-5xl mx-auto px-4 mt-8">
        <div className="flex gap-4 items-center justify-between">
          <Input
            className="w-full h-[80px] bg-purple-400 border-black border-4 px-6 text-3xl font-bold focus:outline-none focus:ring-0 focus:border-black focus-visible:outline-none focus-visible:ring-0 focus-visible:border-black relative shadow-[5px_5px_0px_0px_#000] focus-visible:-translate-x-2 focus-visible:-translate-y-2 focus-visible:shadow-[8px_8px_0px_0px_#000] transition-all duration-300 ease-in-out"
            type="text"
          ...
          >
            ...
            <SelectContent className="mt-4 font-roboto-mono text-black bg-violet-300 border-4 border-black [&>*]:hover:border-black">
              <SelectGroup>
                <SelectItem
                  value="title"
                  className="text-lg tracking-tight focus:bg-purple-300 hover:border-black hover:border-2"
                >
                  Title
                </SelectItem>
                <SelectItem
      ...
      <div className="max-w-5xl mx-auto px-4 mt-14 mb-10">
        {query.trim().length !== 0 && (
          <div>
            {results.length > 0 ? (
              <h3 className="text-3xl font-semibold tracking-tight font-archivo">
